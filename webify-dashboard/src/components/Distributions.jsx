...
const Distributions = ({ onNavigate, darkMode }) => {
    ...
    <div className={`min-h-screen transition-all duration-500 `}>
      ...
      <div className="flex flex-col lg:flex-row lg:gap-8">
        ...
        <div className="flex-1 p-6">
          {/* Toast Notification */}
          {toast.show && (
            <div className={`mb-4 p-4 rounded-lg transition-all duration-300 ${toast.type === 'success'
          ...
          {/* Action Bar */}
          <div className={`mb-8 transition-all duration-700 delay-200 ${animateCharts ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <button
                    ...
                    className={`flex items-center px-3 py-2 border rounded-lg transition-colors duration-300
            ${showFiltersPanel
                        ? (darkMode ? 'bg-green-600 text-white hover:bg-green-700 border-green-600' : 'bg-green-500 text-white hover:bg-green-600 border-green-500')
                        : (darkMode ? 'bg-gray-800 hover:bg-gray-700 text-gray-300 border-gray-600' : 'bg-gray-100 hover:bg-gray-200 text-gray-800 border-gray-300')}`}
                  >
                  ...
                  {/* Filters Panel */}
                  {showFiltersPanel && (
                    <div className={`absolute top-full left-0 mt-2 w-80 rounded-lg shadow-lg z-50 p-4 border transition-colors duration-300
            ${darkMode ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-300 text-gray-800'}`}>
                      <div className="space-y-4">
                        <h3 className="font-semibold">{/* Heading */}Advanced Filters</h3>

                        {/* Date Range Filter */}
                        <div>
                          <label className="block mb-2 text-sm">{/* Label */}Date Range</label>
                          <div className="grid grid-cols-2 gap-2">
                            <input
                              type="date"
                              className={`px-3 py-2 rounded border text-sm placeholder-gray-400 transition-colors duration-300
                      ...
                      ${darkMode ? 'bg-gray-800 border-gray-600 text-white' : 'bg-white border-gray-300 text-gray-800'}`}
                        ...
                        {/* Amount Range Filter */}
                        <div>
                          <label className="block mb-2 text-sm">Amount Range</label>
                          <div className="grid grid-cols-2 gap-2">
                            <input
                              type="number"
                              className={`px-3 py-2 rounded border text-sm placeholder-gray-400 transition-colors duration-300
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-colors duration-300 min-w-[80px]
      ${darkMode
                    ...
                    {openDropdown === 'ytd' && (
                      <div className={`absolute top-full left-0 mt-1 w-full rounded-lg shadow-lg z-50 border transition-colors duration-300
      ${darkMode
                        ...
                        {['YTD', '12M', 'All'].map((option) => (
                          <button
                            ...
                            className={`w-full px-3 py-2 text-left transition-all duration-150 ease-in-out first:rounded-t-lg last:rounded-b-lg
            ${selectedFilters.ytd === option
                                ? (darkMode ? 'bg-green-600 text-white' : 'bg-green-500 text-white')
                                : (darkMode ? 'text-gray-300 hover:bg-gray-700 hover:text-green-400' : 'text-gray-800 hover:bg-gray-100 hover:text-green-600')}`}
                          >
                            {option}
                          </button>
                        ))}
      ...
      ${darkMode
            ...
            ${selectedFilters.status === option
                ...
                <div className="flex-1 max-w-md mx-4">
                  <div className="relative">
                    <svg
                      className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 z-10 transition-colors duration-300
        ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-2 rounded-lg border transition-all duration-200 ease-in-out
        ${darkMode
                          ? 'bg-gray-800 border-gray-600 text-gray-200 placeholder-gray-500 focus:border-green-400 focus:ring-green-600 focus:ring-opacity-50'
                          : 'bg-white border-gray-300 text-gray-800 placeholder-gray-400 focus:border-green-500 focus:ring-green-200'}
      `}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className={`flex items-center px-3 py-2 rounded-lg border transition-colors duration-300
      ${darkMode
                        ? 'bg-transparent border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white'
                        : 'bg-transparent border-gray-300 text-gray-800 hover:bg-gray-100 hover:text-gray-900'}
    `}
                  >
                    <svg
  ...
  `}
    ...
    `}
          ...
          {/* Metric Cards */}
          <div
            className={`grid grid-cols-1 mt-34 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 transition-all duration-700 delay-400 ${animateCharts ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
          >
            {/* CARD 1 */}
            <div
              className={`rounded-xl shadow-lg p-4 lg:p-6 text-center relative overflow-hidden transition-colors duration-300 ${darkMode ? 'bg-gray-800 text-gray-100' : 'bg-white text-gray-900'
                }`}
            >
              ...
              <h3 className={`text-sm lg:text-lg font-semibold mb-2 ${darkMode ? 'text-white' : 'text-gray-600'}`}>
                YTD Distributions
              </h3>
          ...
          <div className={`flex flex-col sm:flex-row sm:justify-end gap-2 sm:gap-4 mb-6 transition-all duration-700 delay-600 ${animateCharts ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}>
            <button
              onClick={() => handlePeriodChange('quarterly')}
              className={`px-4 lg:px-6 py-2 rounded-lg text-sm lg:text-base font-semibold transition-all duration-300 hover:shadow-lg transform hover:scale-105 hover:-translate-y-1 ${selectedPeriod === 'quarterly'
            ...
            <button
              ...
              className={`px-4 lg:px-6 py-2 rounded-lg text-sm lg:text-base font-semibold transition-all duration-300 hover:shadow-lg transform hover:scale-105 hover:-translate-y-1 ${selectedPeriod === 'yearly'
                ? 'bg-green-600 text-white hover:bg-green-700'
                : darkMode
                  ? 'bg-gray-800 text-white border border-gray-600 hover:bg-gray-700 hover:border-green-500 hover:shadow-green-500/30'
                  : 'bg-white text-gray-700 border border-gray-300 hover:bg-green-50 hover:border-green-400 hover:shadow-green-200/50'
          ...
          <div className={`rounded-xl shadow-lg p-4 lg:p-6 mb-6 transition-all duration-1000 delay-800 ${animateCharts ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            } ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-800'}`}>
            <h2 className="text-lg lg:text-xl font-semibold mb-4">Payout History</h2>
          ...
          <div className={`rounded-xl shadow-lg overflow-hidden transition-all duration-1000 delay-1000 ${animateCharts ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                ...
                <thead className={`${darkMode ? 'bg-gray-800 border-b border-gray-700' : 'bg-gray-50 border-b border-gray-200'}`}>
                  <tr>
                    <th className="px-3 lg:px-6 py-3 lg:py-4 text-left">
                      <input type="checkbox" className={`rounded ${darkMode ? 'border-gray-600 text-green-400 bg-gray-800' : 'border-gray-300 text-green-600'}`} />
                    </th>
                    {['Date', 'Amount', 'Type', 'Status', 'Actions'].map((header, idx) => (
                      <th
                        key={idx}
                        className={`px-3 lg:px-6 py-3 lg:py-4 text-left text-xs lg:text-sm font-semibold ${darkMode ? 'text-gray-300' : 'text-gray-700'
                          }`}
                      >
                        {header}
                      </th>
                ...
                <tbody className={darkMode ? 'divide-y divide-gray-700' : 'divide-y divide-gray-200'}>
                  {tableData.map((row, index) => (
                    ...
                    >
                      ...
                      <td className={`px-3 lg:px-6 py-3 lg:py-4 text-xs lg:text-sm ${darkMode ? 'text-white' : 'text-gray-900'}`}>{row.date}</td>
                      <td className={`px-3 lg:px-6 py-3 lg:py-4 text-xs lg:text-sm ${darkMode ? 'text-white' : 'text-gray-900'}`}>{row.amount}</td>
                      <td className="px-3 lg:px-6 py-3 lg:py-4">
                      ...
                      <td className="px-3 lg:px-6 py-3 lg:py-4">
                        <div className="flex items-center">
                          {row.status === 'Paid' ? (
                            <>
                              <svg className="w-3 h-3 lg:w-4 lg:h-4 text-green-500 mr-1 lg:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                              </svg>
                              <span className="text-xs lg:text-sm text-green-500">Paid</span>
                            </>
                          ) : (
                            <>
                              <svg className="w-3 h-3 lg:w-4 lg:h-4 text-orange-500 mr-1 lg:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                              </svg>
                              <span className="text-xs lg:text-sm text-orange-500">Scheduled</span>
                            </>
                          )}
                        </div>
                      </td>
                      <td className="px-3 lg:px-6 py-3 lg:py-4">
                        <div className="flex flex-wrap gap-1 lg:gap-2">
                          <button
                            ...
                            className={`flex items-center px-2 lg:px-3 py-1 rounded text-xs transition-all duration-200 transform hover:scale-105
                    ${darkMode
                                ? 'bg-gray-800 border border-gray-600 text-white hover:bg-blue-900 hover:border-blue-500'
                  ...
                  `}
                          ...
                          {row.status === 'Scheduled' && (
                            <button
                              ...
                              className={`flex items-center px-2 lg:px-3 py-1 rounded text-xs transition-all duration-200 transform hover:scale-105
                      ${darkMode
                                  ? 'bg-gray-800 border border-gray-600 text-white hover:bg-green-900 hover:border-green-500'
            ...
            {/* Pagination */}
            <div className={`${darkMode ? 'bg-gray-800 border-t border-gray-700' : 'bg-gray-50 border-t border-gray-200'} px-4 lg:px-6 py-3 lg:py-4`}>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                <span className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} text-xs lg:text-sm`}>Page 2 / 2 • 12 results</span>
          ...
          {/* Bottom Widget Cards */}
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mt-6 transition-all duration-1000 delay-1200 ${animateCharts ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            }`}>
            {/* Breakdown Card */}
            <div className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} rounded-xl shadow-lg p-4 lg:p-6`}>
              <div className="flex items-center justify-between mb-4">
                <h3 className={`text-base lg:text-lg font-semibold ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>Breakdown (filtered)</h3>
              </div>
              <div className="h-24 lg:h-32 mb-4">
                <Pie data={breakdownData} options={pieChartOptions} />
              </div>
              <div className="text-center">
                <span className={`text-xs lg:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Cash - 75%</span>
              </div>
            </div>

            {/* Bank Instructions Card */}
            <div className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} rounded-xl shadow-lg p-4 lg:p-6`}>
              <h3 className={`text-base lg:text-lg font-semibold mb-4 ${darkMode ? 'text-white' : 'text-black'}`}>Bank Instructions</h3>
              <div className="space-y-2 lg:space-y-3">
                <div className="flex items-center gap-2">
                  <span className={`text-xs lg:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-400'}`}>Bank:</span>
                  <span className={`text-xs lg:text-sm font-medium ml-auto ${darkMode ? 'text-white' : 'text-black'}`}>First Federal</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className={`text-xs lg:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-400'}`}>Account:</span>
                  <span className={`text-xs lg:text-sm font-medium ml-auto ${darkMode ? 'text-white' : 'text-black'}`}>**** 4821</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className={`text-xs lg:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-400'}`}>Routing:</span>
                  <span className={`text-xs lg:text-sm font-medium ml-auto ${darkMode ? 'text-white' : 'text-black'}`}>*****123</span>
                </div>
              </div>
              <div className="flex gap-2 mt-4">
                <button
                  className={`px-3 py-1.5 text-xs lg:text-sm rounded border transition-all duration-150
          ${darkMode
                      ? 'border-gray-500 text-gray-200 bg-transparent hover:bg-gray-700 hover:border-gray-400'
                      : 'border-gray-500 text-gray-800 bg-transparent hover:bg-gray-100 hover:border-gray-400'}
        `}
                >
                  Request change
                </button>
        ...
        `}
            ...
            <div className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} rounded-xl shadow-lg p-4 lg:p-6`}>
              <div className="flex items-center justify-between mb-4">
                <h3 className={`text-base lg:text-lg font-semibold ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>Download Center</h3>
                <button className={`text-xs lg:text-sm transition-all duration-200 ease-in-out hover:scale-105 hover:font-medium ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-gray-700'
                  }`}>
                  Clear
                </button>
              </div>
              <div className="text-center py-6 lg:py-8">
                <p className={`text-xs lg:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>No files yet. Use CSV/ICS/Statement.</p>
              </div>
            </div>
          </div>
